...
reqs:
	sudo apt-get install -y luajit luarocks git build-essential libssl-dev libluajit-5.1-dev lua-cjson-dev sysv-rc-conf meson libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev inotify-tools
